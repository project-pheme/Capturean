...
public class GenericSerialize<T> implements ISerialize<T> {
	
	private ObjectMapper mapper;
	
	
	public GenericSerialize (Class<T> messageClass) {
		mapper = new ObjectMapper();
		mapper.setSerializationInclusion(Include.NON_NULL);
	}	

	@Override
	public String serialize(T item) throws CaptureException, JsonProcessingException {
