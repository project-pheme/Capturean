...
public class ExampleConsumer {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		IDeserialize<PhemeSource> deserializer = new GenericDeserialize<PhemeSource>(PhemeSource.class);
		
		ConsumerClient<PhemeSource> client = new ConsumerClient<PhemeSource>(config, deserializer);
