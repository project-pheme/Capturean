...
public class HBaseCountTest {
	...
	public static void main(String[] args) throws Throwable {
		...
		long count = hbp.getDcCountFaster(dcId);
		long endTime = System.currentTimeMillis();
		System.out.println("Counting tweets took: " + (endTime - startTime) + " milliseconds");
		System.out.println("Count: " + count);
		
		startTime = System.currentTimeMillis();
		count = hbp.getDcCountSlow(dcId);
		endTime = System.currentTimeMillis();
		System.out.println("Counting tweets took: " + (endTime - startTime) + " milliseconds");	
		System.out.println("Count: " + count);
		
		startTime = System.currentTimeMillis();
		count = hbp.getDcCountSlow1(dcId);
		endTime = System.currentTimeMillis();
		System.out.println("Counting tweets took: " + (endTime - startTime) + " milliseconds");	
		System.out.println("Count: " + count);
		...
		dp.setName("Artificial tweets");
		hbp.storeDataPool(dp);
		
		//Generate 1_000_000 tweets:
		System.out.println("Generating tweets...");
		for (int i=0; i<100; i++) {
			List<Tweet> tweetList = hbp.generateTweets(10000);
			hbp.addTweetsToDCBatch(tweetList, dp.getPoolID());			
		}
