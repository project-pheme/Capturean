...
public class CaptureAnalyticJPA implements CaptureAnalyticIf {
	...
	public Map<Date, Integer> getVolumePer(List<String> dcIdList, String dcId,
			Date initDate, Date endDate, Periodicity per)
	...
	public Map<Date, Map<DataChannel, Double>> getSentimentDegree(
			List<String> dcIdList, Date initDate, Date endDate, Periodicity per)
			throws CaptureException {
		// TODO Auto-generated method stub
		return null;
	}
