...
<html>
    <head>
		...
		<link rel="stylesheet" href="bootstrap/capture.css" />
		<link rel="stylesheet" href="bootstrap/mk/MarkerCluster.css" />
		<link rel="stylesheet" href="bootstrap/mk/MarkerCluster.Default.css" />
    ...
    <body class="skin-blue">
            ...
            <aside class="left-side sidebar-offcanvas">                
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        <li>
                            <a href="./">
                                <i class="fa fa-dashboard"></i> <span>Data Channels</span>
                            </a>
                        </li>
                        <li>
                            <a href="new">
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu" style="display: block;">
                                <li><a href="#stream"  role="tab" data-toggle="tab"><i class="fa fa-angle-double-right"></i> Twitter Stream</a></li>
                                <li><a href="#geo" role="tab" data-toggle="tab"><i class="fa fa-angle-double-right"></i> Maps</a></li>
                            </ul>
                        </li>
                        <li class="treeview">
                            <a href="#">
                            ...
                            <ul class="treeview-menu">
                                <li class="disabled"><a href="#"><i class="fa fa-angle-double-right"></i> Aggregates</a></li>
                                <li class="disabled"><a href="#"><i class="fa fa-angle-double-right"></i> Faceted Queries</a></li>
                                <li class="disabled"><a href="#"><i class="fa fa-angle-double-right"></i> Sentiment scores</a></li>
                            </ul>
                        </li>
                        ...
                        <li>
                            <a href="status">
                                <i class="fa fa-envelope"></i> <span>System status</span>
                                <small class="badge pull-right bg-green">OK</small>
                            </a>
                        </li>
                    </ul>
                </section>
		...
		<script src="bootstrap/consumer2.js"></script>
