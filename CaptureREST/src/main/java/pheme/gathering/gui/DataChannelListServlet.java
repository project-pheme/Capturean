...
public class DataChannelListServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
    	try {
			...
			DataChannelList output = response.getEntity(DataChannelList.class);

			webResource = client.resource(endpoint + "/datapool/");
			...
			DataPoolList outputDp = response.getEntity(DataPoolList.class);

			
			req.setAttribute("datachannels", output);
			req.setAttribute("datapools", outputDp);
			
	    	req.getRequestDispatcher("datachannels.jsp").forward(req, resp);
		} catch (Exception e) {
