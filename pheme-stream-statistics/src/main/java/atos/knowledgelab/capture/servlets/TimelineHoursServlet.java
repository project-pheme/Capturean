...
public class TimelineHoursServlet extends HttpServlet {

	ObjectMapper mapper = new ObjectMapper();
	private static Logger LOGGER = Logger.getLogger(TimelineHoursServlet.class.getName());
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		try {
			...
			if (pathInfo != null && pathInfo.length() != 0) {
    			...
    			String s = mapper.writeValueAsString(tc.getHours());
