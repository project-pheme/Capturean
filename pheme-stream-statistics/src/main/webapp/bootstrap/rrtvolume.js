...
//				}			  
		      ...
		      console.log('rrtvolumedata?id='+iD+'&fInit='+moment(dI).utc().format("ddd MMM DD YYYY HH:mm:ss z")+'&fEnd='+moment(dF).utc().format("ddd MMM DD YYYY HH:mm:ss z")+'&sizeSec='+"minutes1"+'&numIds='+numIds);
		      $("#loading-indicator").show();
		      var d=dataRT('rrtvolumedata?id='+iD+'&fInit='+moment(dI).utc().format("ddd MMM DD YYYY HH:mm:ss z")+'&fEnd='+moment(dF).utc().format("ddd MMM DD YYYY HH:mm:ss z")+'&sizeSec='+"minutes1"+'&numIds='+numIds);//Math.random();
			  console.log(d);			  
			  datos=new Array();
			  ...
			  var dVT=dataRT('rrtvolumedata?id='+idsVT+'&fInit='+moment(dI).utc().format("ddd MMM DD YYYY HH:mm:ss z")+'&fEnd='+moment(dF).utc().format("ddd MMM DD YYYY HH:mm:ss z")+'&sizeSec='+"minutes1"+'&numIds='+1);//Math.random();
			  console.log(dVT);			  
			  datosVT=new Array();
			  for (var i=0; i<dVT.length;i++){
				  dVT[i][0]=new Date(dVT[i][0]);
				  datosVT[i]=dVT[i];
			  }		
			  //datos=new Array();
//			  datos.push([new Date("2015-12-07T22:10:00.000Z"),614,580,229,209]);
//			  datos.push([new Date("2015-12-07T23:10:00.000Z"),214,280,29,109]);
//			  datos.push([new Date("2015-12-07T21:10:00.000Z"),114,180,109,100]);
//			  datos.push([new Date("2015-12-08T00:10:00.000Z"),124,190,199,200]);
//			  datos.push([new Date("2015-12-07T20:10:00.000Z"),314,108,290,500]);
			  //datos=[[new Date("2015-12-07T22:10:00.000Z"),614,580,229,209],[new Date("2015-12-07T23:10:00.000Z"),214,280,29,109],[new Date("2015-12-08T00:10:00.000Z"),114,180,109,100]];
			  //console.log("d.length="+d.length);	
			  //console.log("d[0].length="+d[0].length);
			  //console.log("d[0]="+d[0]);
...
//			jsonData[i][0] = new Date(moment(jsonData[i][0]).format("YYYY-MM-DDTHH:mm:ss")).toISOString();			
//	    }		
//		console.log("jsonDates="+jsonData);
//	    return jsonData.sort(order());
//	}
