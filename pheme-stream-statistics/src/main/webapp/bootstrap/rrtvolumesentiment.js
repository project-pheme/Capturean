...
$(document).ready(function() {
	...
	function callVolumeUpdate(fIni, fFin,sec){
		...
		if((idS.length>0)&&(sec!=null)&&(sec!=undefined)){
		      ...
		      var dV=dataRT('rrtvolumedata?id='+iD+'&fInit='+moment(dI).utc().format("ddd MMM DD YYYY HH:mm:ss z")+'&fEnd='+moment(dF).utc().format("ddd MMM DD YYYY HH:mm:ss z")+'&sizeSec='+"minutes1"+'&numIds='+numIds);//Math.random();
			  console.log(dV);			  
			  datosV=new Array();
